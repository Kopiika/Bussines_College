	 ...
	 function processOrderPromise() {
		return new Promise ((resolve) => {
			...
			.then((message) => {
				...
				return new Promise ((resolve) => {
					setTimeout(() => {
						resolve (`"Tilausta valmistellaan"`)
					}, 3000);
				});
			})
			.then ((message) => {
				...
				return new Promise ((resolve) => {
					setTimeout(() => {
						resolve (`"Tilaus valmis noudettavaksi"`)
					}, 1000);
				});
			})
		};
